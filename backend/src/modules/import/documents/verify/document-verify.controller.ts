...
import { BulkVerifyDocumentsDto } from "../../../../dto/bulk-verify.dto";
...
export class VerifyDocumentController {
  ...
  @Roles("ADMIN")
  @Patch("bulk/verify")
  bulkVerifyDocuments(@Body() body: BulkVerifyDocumentsDto, @Req() req) {
  ...
  verifyOneDocument(
    ...
    return this.verifyDocumentService.verifyOneDocument(
      documentId,
      dto,
      req.user,
    );
